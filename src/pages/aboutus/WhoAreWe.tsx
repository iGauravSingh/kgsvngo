...
const WhoAreWe = () => {
  return (
    ...
    <div className="App">
      ...
      <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: "url('/img/eleven.jpg')" }}>
