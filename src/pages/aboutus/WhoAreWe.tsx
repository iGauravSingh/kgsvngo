...
const WhoAreWe = () => {
  return (
    ...
    <div className="mx-8 font-popins">
      ...
      <div className="relative w-full h-[256px] bg-cover bg-center" style={{ backgroundImage: "url('/originalpagesimages/who-r-we.jpg')" }}>
        {/* <div className="absolute inset-0 bg-black opacity-50"></div> */}
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-4xl font-bold font-CormorantUpright">Who Are We</h1>
        </div>
      </div>
