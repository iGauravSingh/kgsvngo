    ...
    return (
      <div className="">
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 font-popins ">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-center mb-6 text-greenngo">
          ...
          <div className=" p-6 mt-4 font-popins bg-white/50 shadow-lg  px-4 py-4 rounded-xl">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4 text-center text-greenngo">
