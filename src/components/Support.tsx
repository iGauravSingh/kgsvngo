...
const supportArray = ["Education","Cleanliness","Health","Environmental","Women","Training","Agriculture"]
    ...
    return (
      <div className="">
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 font-popins ">
          ...
          <div className=" w-[180px] h-16 bg-[#ff1949] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <LuBookOpen size={25} />
              <p className="">{supportArray[0]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#67e8f9] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <MdOutlineCleaningServices size={25} />
              <p className="">{supportArray[1]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#45b29d] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <MdOutlineHealthAndSafety size={25} />
              <p className="">{supportArray[2]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#176e3b] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <LuTreePine size={25} />
              <p className="">{supportArray[3]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#e24277] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <SlUserFemale size={25} />
              <p className="">{supportArray[4]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#212635] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <GiGearHammer size={25} />
              <p className="">{supportArray[5]}</p>
            </div>
            <div className=" w-[180px] h-16 bg-[#69bb35] flex gap-2 justify-center items-center px-4 py-8 text-white">
              <PiFarm size={25} />
          ...
          <div className=" p-6 mt-4 font-popins bg-white/50 shadow-lg  px-4 py-4 rounded-xl">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 text-center text-greenngo">
